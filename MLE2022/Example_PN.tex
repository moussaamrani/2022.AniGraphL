...
\begin{figure}%
   \includegraphics[width=\columnwidth,clip, trim=0cm 8cm 19.7cm 0cm]{PN_MM}%
   \caption{A metamodel (top) and model (bottom) for Petri Nets.}%
   \label{fig:PN}%
   \Description[A metamodel and model for Petri Nets]{%
   A metamodel and model for Petri Nets.}
\end{figure}
...
corresponding output \textsf{Arc}s' \textsf{weight}. Note that an enabled \textsf{Transition}
...
\begin{description}
   ...
   \begin{description}
      ...
      and creating new markings on the output \textsf{Place}s.
