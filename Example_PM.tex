...
\begin{figure*}[t]
   ...
   \label{fig:PacMan}
   \Description[Specification of a \DSL for PacMan.]{
   A metamodel and a part of the model transformation for expressing the PacMan
   \DSL behaviour, are described with different styles, and different representations.
   }
\end{figure*}
...
\begin{description}
   ...
   by one \textsf{Persona} making a move to an already occupied \textsf{Cell}.
\end{description}
