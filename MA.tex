...
\begin{figure}[t]%
   \centering
   \includegraphics[width=0.8\columnwidth,clip, trim=0cm 10cm 25cm 0.2cm]{UAScheduling}%
   ...
   \Description[Scheduling of Animation Units.]{
   Animation Units may be scheduled with pre- and post-conditions attached to them,
   or with combinators, i.e. combination operators organising units in a tree.
   }
\end{figure}
